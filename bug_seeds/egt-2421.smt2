...
(assert (not (= (concat (_ bv0 24) (_ bv0 8)) (concat (_ bv0 24) (select packet (_ bv28 32))))))
...
(assert (= (concat (_ bv0 24) (select packet (bvadd (_ bv242 32) (concat (_ bv0 24) (select packet (_ bv241 32)))))) (_ bv52 32)))
(assert (bvsle (_ bv308 32) (bvadd (bvadd (bvadd (_ bv0 32) (bvadd (concat (_ bv0 24) (select packet (_ bv241 32))) (_ bv2 32))) (_ bv1 32)) (concat (_ bv0 24) (_ bv0 8)))))
(check-sat)
(exit)
